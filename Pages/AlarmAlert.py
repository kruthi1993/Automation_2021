...
class AlarmAlert(BasePage):
    Alerts_Module =(By.XPATH,"//span[text()='Alerts']")
    Alarm_Alert = (By.XPATH,"//a[text()='Alarm Alerts']")
    ...
    """Page Actions"""
    """This is used to the Navigate to Alarm Alert Module"""
    def alarm_alert_click(self):
        self.mouse_over(self.Alerts_Module)
        self.do_click(self.Alarm_Alert)

    """This is used to the Export the Alarm Alerts"""
    ...
    """This is used to the Export the Alarm Alerts to Excel"""
    def export_to_excel(self,confirmation):
        self.export_all_alerts()
        self.confirmation(confirmation)


    """This is used to the Create the Alarm Tickets"""
